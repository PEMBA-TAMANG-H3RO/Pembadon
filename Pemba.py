#WRITTEN BY PEMBA-HERO
#FOLLOW MY GITHUB: https//github.com/PEMBA-HERO
#-------import------#
#-------logo---------#
logo=("_____  ______ __  __ ____            ________   ________ 
 |  __ \|  ____|  \/  |  _ \   /\     |  ____\ \ / /  ____|
 | |__) | |__  | \  / | |_) | /  \    | |__   \ V /| |__   
 |  ___/|  __| | |\/| |  _ < / /\ \   |  __|   > < |  __|  
 | |    | |____| |  | | |_) / ____ \  | |____ / . \| |____ 
 |_|    |______|_|  |_|____/_/    \_\ |______/_/ \_\______| ")
 #-------clear-------#
 def clear():
   os.system('clear')
   print(logo)
   print(42*'-')
   print('FB PAGE : PEMBA EXE')
   print('GITHUB:PEMBA-HERO')
   print(42*'-')
   #--------line-------#
   def line():
   print(42'-')
...
def ___file___():
   ...
   clear()
try:
  pas_limit=int(intput('[??] ENTER PASSWORD LIMIT (1-20) :')
  except:
      pas_limit=1
   line()
